...
def generate_full_descriptive_report(df, output_path="/workspaces/work1/問卷描述性統計報告_完整版.docx"):
    ...
    # 涵蓋：股權結構、董事會治理、資訊揭露、內部控制、利害關係人、風險管理、策略規劃等七大面向
    topics = [
        # === 一、股權結構與控制權（3題）===
        {
            'col': '請問您投資的公司之大股東（持股5%以上）合計持股比例為多少？',
            'title': '3.1 大股東合計持股比例',
            'description': '分析大股東合計持股比例，評估股權集中程度與控制權分配。股權集中度是公司治理的基礎指標，影響決策效率與股東權益保護。'
        },
        {
            'col': '請問您投資的公司之經營團隊合計持股比例為多少？',
            'title': '3.2 經營團隊持股比例',
            'description': '分析經營團隊持股情況，了解管理層與公司利益的一致性程度。經營團隊持股比例反映所有權與經營權的結合程度，是評估代理問題的關鍵指標。'
        },
        {
            'col': '請問您投資的公司之外部投資人（創投、私募基金等）合計持股比例為多少？',
            'title': '3.3 外部投資人持股比例',
            'description': '評估外部專業投資人的持股情況，反映公司獲得外部資金挹注與專業監督的程度，是企業成長性與投資價值的重要指標。'
        },
        
        # === 二、董事會治理機制（5題）===
        {
            'col': '董事會結構與運作 - 您投資的公司之董事會決議方式能夠清楚載明，且議事錄完整記載會議資訊（如時間、地點、主席、決議方法及結果）',
            'title': '3.4 董事會決議與議事錄完整性',
            'description': '評估董事會決策的透明度與記錄完整性。完整的議事錄是確保董事會決策可追溯性的基礎，也是公司治理品質的重要指標。'
        },
        {
            'col': '董事會結構與運作 - 您投資的公司之董事針對與自身利害相關的議題會說明與利益迴避',
            'title': '3.5 董事利益迴避機制',
            'description': '評估公司董事會的利益衝突管理機制。利益迴避制度是防範內部人利益輸送的關鍵機制，直接影響少數股東權益保護。'
        },
        {
            'col': '董事會結構與運作 - 您投資的公司之董事會成員專業背景涵蓋兩種（含）以上（如：財務、法律、技術等）',
            'title': '3.6 董事會專業多元性',
            'description': '評估董事會成員專業背景的多元性，確保決策品質。多元的專業背景有助於全方位審視公司策略，降低決策盲點。'
        },
        {
            'col': '董事會結構與運作 - 您投資的公司之董事會至少每季召開一次',
            'title': '3.7 董事會召開頻率',
            'description': '調查董事會的開會頻率與定期性。定期召開董事會是確保董事會有效運作、即時監督公司營運的基本要求。'
        },
        {
            'col': '董事會結構與運作 - 您投資的公司之董事會設有獨立董事或外部董事',
            'title': '3.8 獨立董事設置',
            'description': '評估公司是否設置獨立董事或外部董事。獨立董事能提供客觀建議，強化董事會監督功能，是優化公司治理的重要措施。'
        },
        
        # === 三、財務報告與資訊透明度（4題）===
        {
            'col': '您投資的公司在最近一期的年度財務報表，是否委任外部會計師進行查核簽證？若有，其遵循的會計準則為何？',
            'title': '3.9 財務報表查核與會計準則',
            'description': '調查公司財務報表的外部查核情況與會計準則遵循。外部查核是確保財務資訊可信度的關鍵機制，是投資人決策的重要依據。'
        },
        {
            'col': '資訊透明度 - 您投資的公司通常多久向股東提供財務報告',
            'title': '3.10 財務報告提供頻率',
            'description': '了解公司向股東揭露財務資訊的頻率與即時性。定期且及時的財務報告是股東監督管理層的基礎，反映公司資訊透明度。'
        },
        {
            'col': '資訊透明度 - 您投資的公司通常多久向股東揭露董事、監察人、經理人及持股超過10%大股東的持股情形、股權質押比率與前十大股東之股權結構圖或表',
            'title': '3.11 股權結構資訊揭露',
            'description': '評估公司股權結構資訊的透明度與更新頻率。股權結構揭露讓投資人了解公司控制權變動與潛在利益衝突，是重大資訊透明的體現。'
        },
        {
            'col': '資訊透明度 - 您投資的公司會定期向股東揭露營運績效與重大訊息（如：訂單、合約、投資案等）',
            'title': '3.12 營運績效與重大訊息揭露',
            'description': '調查公司是否定期揭露營運績效與重大訊息。即時的資訊揭露能降低資訊不對稱，提升投資人信心與市場效率。'
        },
        
        # === 四、內部控制與風險管理（4題）===
        {
            'col': '內控與風險評估（含財務與營運風險） - 您投資的公司由不同人員分別負責出納與會計',
            'title': '3.13 財務職能分工',
            'description': '評估公司財務內部控制的基本分工情況。出納與會計分工是財務內控的基石，有效防止舞弊與錯誤，是未上市櫃公司最基本但最關鍵的控制點。'
        },
        {
            'col': '內控與風險評估（含財務與營運風險） - 您投資的公司建立內部控制制度，並定期評估其有效性',
            'title': '3.14 內部控制制度建立與評估',
            'description': '調查公司內部控制制度的建立與定期評估機制。完善的內控制度是確保營運效率、財務報導可靠性及法令遵循的基礎。'
        },
        {
            'col': '內控與風險評估（含財務與營運風險） - 您投資的公司建立風險管理機制，並能辨識營運相關之重大風險',
            'title': '3.15 風險管理機制',
            'description': '評估公司風險管理機制的完整性。有效的風險管理能及早辨識潛在威脅，保護公司價值，是企業永續經營的關鍵。'
        },
        {
            'col': '內控與風險評估（含財務與營運風險） - 您投資的公司訂有資訊安全管理政策或機制',
            'title': '3.16 資訊安全管理',
            'description': '調查公司資訊安全管理政策的建立情況。在數位時代，資訊安全是保護商業機密與客戶資料的首要防線，直接影響企業信譽與競爭力。'
        },
        
        # === 五、利害關係人治理（2題）===
        {
            'col': '利害關係人 - 您投資的公司其員工分紅制度設計能有效激勵員工',
            'title': '3.17 員工激勵制度',
            'description': '評估公司員工激勵機制的有效性。有效的員工激勵制度能將員工利益與公司長期發展結合，是人力資本管理與公司永續經營的關鍵。'
        },
        {
            'col': '利害關係人 - 您投資的公司重視客戶權益，並建立客戶申訴管道',
            'title': '3.18 客戶權益保護',
            'description': '調查公司對客戶權益的重視程度與申訴機制。良好的客戶關係管理是企業永續經營的基礎，反映公司的社會責任與商譽。'
        },
        
        # === 六、策略規劃與永續發展（2題）===
        {
            'col': '請問您投資的公司是否設立公司中長期願景與目標？',
            'title': '3.19 中長期願景與目標設立',
            'description': '評估公司是否建立明確的中長期發展願景與目標。清晰的願景能凝聚組織共識，指引策略方向，是企業永續成長的基石。'
        },
        {
            'col': '請問您投資的公司是否關注永續發展議題（如ESG：環境、社會、治理）？',
            'title': '3.20 永續發展與ESG重視程度',
            'description': '調查公司對ESG永續發展議題的關注程度。ESG表現日益成為投資決策的重要考量，提前布局有助於提升企業長期競爭力與投資價值。'
        },
    ]
